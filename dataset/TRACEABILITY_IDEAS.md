...
- **Every figure links to its source.** Nearly every row carries `source_url`. Make it clickable, that single feature is what separates this from a scraped aggregator.
